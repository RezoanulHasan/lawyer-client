...
const Footer = () => {
  ...
  return (
   ...
   <p  style={{textShadow: '0 0 3px #FF0000,0 0 4px #FF0000 '}}  
   className="font-bold  text-white  text-xl">Lawyer Hiring </p>
     
    
       <p className="font-bold   text-white ">
                Copyright © 2023 - All right reserved by Rezoanul Hasan 
              </p>
